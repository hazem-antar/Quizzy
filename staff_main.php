...
session_start();
  ...
  $query_exams = "SELECT courses.course_name, courses.course_code, quizzes.date,
	...
	WHERE courses.instructor_id = '$id' AND quizzes.date>=DATE(NOW())
  ...
  if($result_exams && mysqli_num_rows($result_exams) > 0){
    ...
    $exam_col_arr = array('course_name','course_code','date','start_time','end_time','questions_count','students_count');
...
<html>
  <head>
    ...
    <ul>
      <li><a id="active" href="staff_main.php">Home</a></li>
  ...
  <body>
    ...
    <div id="white_box_2">
      ...
      <form action="staff_exams.php">
        <input class= "button" type="submit" value="Modify Exams" />
      </form>
    </div>
    <script>
